				...
				<div class="board_box">
					...
					<div>
						<c:forEach var="item" items="${list}">
							<div>
								<span><c:out value="item.bno"></c:out></span>
								<span><c:out value="item.btitle"></c:out></span>
								<span><c:out value="item.bcontent"></c:out></span>
								<span><c:out value="item.bwrdate"></c:out></span>
							</div>
						</c:forEach>
					</div>
					<!--내용작성 end -->

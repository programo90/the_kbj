...
<script>
	...
	$(document).ready(function() {
		...
		var brecount = 0;
		$.ajax({
					url : 'opinionreplyList.do',
					data : {'num' : no },
					dataType : 'json',
					method : 'post',
					success : function(data) {
						console.log(data + "bbb" + data + 123);
								$.each(data, function(index, item) {
									...
									if(${sessionScope.dto.mnick == requestScope.bdto.mnick }) {
										result += '<a href="opinionRepdel.do?rno=' + item.rno + '&bno=' + ${bdto.bno } +'">삭제</a>'; 
									}
						...
						<div class="row">
							<div class="col-md-12">
												...
												<p>${bdto.bcontent }</p>
													<div class="row">
														<div class="col-md-4"></div>
															<div class="col-md-1" id="like-box" >
														...
														<div class="col-md-1" id="modify-box">
															<a href="opinionModify.do?bno=${bdto.bno}"><span class="glyphicon glyphicon-refresh"> Modify</span></a>
													
														</div>
												
														<div class="col-md-1" id="delete-box">
													      	<a href="opinionDel.do?bno=${bdto.bno}"><span class="glyphicon glyphicon-trash"> Delete</span></a>
													    </div>
								...
								<div class="reply-con">
									...
									<div class="reply-login"></div>
									<form action="opinionRepinsert.do" method="post" name="frm" class="reply-frm">
										<c:choose>

					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-12" id="con-row">
								<div class="row">
									<div class="col-md-12">
										<form role="form" action="opinionModifyresult.do" method="post"
											name="frm">
											...
											<div class="form-group">
												<label for="ctg-sel">카테고리</label> <br> <select
													...
													<option value="op" selected="selected">오피니언</option>
												</select>
											</div>
											<div class="form-group">
												<label for="tag-sel">태그</label> <br> <select
													...
													<c:choose>
														<c:when test="${requestScope.dto.btag == 'eco'}">
															<option value="eco" selected="selected">경제</option>
															<option value="ent">연예</option>
															<option value="spo">스포츠</option>
														</c:when>
														<c:when test="${requestScope.dto.btag == 'ent'}">
															<option value="eco">경제</option>
															<option value="ent" selected="selected">연예</option>
															<option value="spo">스포츠</option>
														</c:when>
														<c:when test="${requestScope.dto.btag == 'spo'}">
															<option value="eco">경제</option>
															<option value="ent">연예</option>
															<option value="spo" selected="selected">스포츠</option>
														</c:when>
													</c:choose>
												</select>
											</div>

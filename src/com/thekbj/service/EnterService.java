...
public class EnterService {
   ...
   public List<TableDTO> boardList(int startrow, int pagepercount, String search, String txtsearch, String bview) {
      ...
      try {
         ...
         list=dao.boardListData(conn, startrow, pagepercount, search, txtsearch, bview);
   ...
   public TableDTO boardDetail(int boardnum) {
      ...
      try {
         ...
         dao.replyTotalcount(conn, boardnum);
